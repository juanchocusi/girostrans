...
if (isset($_GET['term']) || isset($_GET["opcion"]) ){
    ...
    if ($_POST["opcion"] === "INSERTA") {
        $query = $mysqli->query(" call spInsertaListaUsuarios('".$_POST["dni"]."','".$_POST["apellidos"]."','".$_POST["nombres"]."','".$_POST["nick"]."','".$_POST["direccion"]."','".$_POST["telefono"]."','".$_POST["email"]."','".$_POST["pw"]."','".$_POST["tipo"]."','".$_POST["idempresa"]."') ");
        $datos = array();
        while ($usuarios = $query->fetch_array()) {
            $datos[] = array(
                "id"         => $usuarios["idusuario"],
