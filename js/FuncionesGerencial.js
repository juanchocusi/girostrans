...
var suma_ci = 0;  var suma_sc = 0;  var suma_se = 0; var suma_og=0; var suma_oga=0;
var sumaci = 0; var suma_tsa = 0;   var ssaldoi =0; var suma_comi_inter=0; var suma_bono=0;
var sum_saldoi_s=0; var sum_pendientes=0; var sum_varios=0; var sum_letras=0; var sum_combustibles=0; var sum_alimentos=0;  var sum_viaticos=0; 
var sum_ctaxpagar=0; var sum_otros_s=0; var sum_entregados=0; var sum_traslado_efectivo_s=0; var sum_ttotal_s=0;
var sum_saldoi_i=0; var sum_retiro_banco=0; var sum_transf_recibidas=0;  var sum_ctaxcobrar=0; var sum_otros_i=0; var sum_traslado_efecectivo_i=0; var sum_ttotal_i=0;
var sum_ingresos_salidas=0; var sum_transf_pendientes=0; var sum_efectivo_neto=0; var sum_total_flujocajae=0;

function fnTotalesRGastosxSucursal() {
sum_saldoi_s=0; sum_pendientes=0; sum_varios=0; sum_letras=0; sum_combustibles=0; sum_alimentos=0; sum_viaticos=0; 
sum_ctaxpagar=0; sum_otros_s=0;  sum_entregados=0; sum_traslado_efectivo_s=0; sum_ttotal_s=0;
...
function fnTotalesRIngxSucursal() {
    svarios = 0;    sletras = 0;    sotros = 0;    sctasxp = 0;    sctasxc = 0;    spendientes = 0;
...
suma_ci = 0; suma_sc = 0; suma_se = 0; suma_og = 0; 
...
var total1=0; tsaldo_efectivo=0;  var tsaldo_asociado=0; var suma_saldos_asoc_agente=0;    var suma_comi_itf=0; var suma_saldoi=0; var suma_gastos=0;
...
//        $.blockUI({ message: "<h1><img src='img/loader32.gif'/>Cargando datos desde el servidor...</h1>" }); 
        $.blockUI({ message: $('#mensaje_carga'), css: { width: '275px' } }); 
            if($.fn.dataTable.isDataTable('#TResumenAsociado')){$('#TResumenAsociado').dataTable().fnDestroy();}                        
            FnMuestraRAsociado();
            if($.fn.dataTable.isDataTable('#TResumenAgente')){('#TResumenAgente').dataTable().fnDestroy();}
             FnMuestraRAgente();
            if($.fn.dataTable.isDataTable('#TIngresosxSucursal')){('#TIngresosxSucursal').dataTable().fnDestroy();}
             FnMuestraIngxSucursal();
             if($.fn.dataTable.isDataTable('#TGastosxSucursal')){('#TGastosxSucursal').dataTable().fnDestroy();}            
             FnMuestraGastosxSucursal();
