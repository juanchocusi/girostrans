...
//$ntsal=number_format($tsal,2,".",",");
//$nting=number_format($ting,2,".",",");	
$html = $html . '<tfoot > <tr><th></th><th></th><th align="center" style="font-size:120%;">Total</th><th align="rigth" style="font-size:120%;">' . number_format($ting,2,".",",") . '</th><th align="rigth" style="font-size:120%;">' . number_format($tsal,2,".",",") . '</th></tr> </tfoot>';
$html = $html . '</table></div>';
$pdf->writeHTML($html, true, false, false, false, '');
///////////////////////////////////////////////////////////////////////////////////////////////////////
$pdf->SetFont('times', '', 12);
$pdf->SetFillColor(255, 255, 255);
$pdf->MultiCell(35, 5, 'Total Entregados '. number_format($_GET['tentregados'],2,".",","), 1, 'C', 1, 0, '', '', true);
$pdf->MultiCell(35, 5, 'Total Recibidos '.number_format($_GET['trecibidos'],2,".",","), 1, 'C', 1, 0, '', '', true);
$pdf->MultiCell(35, 5, 'Total Pendientes '.number_format($_GET['tpendientes'],2,".",","), 1, 'C', 1, 0, '', '', true);
$pdf->MultiCell(35, 5, 'Efectivo Neto '.number_format($_GET['efectivo_neto'],2,".",","), 1, 'C', 1, 0, '', '', true);
