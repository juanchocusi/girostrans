...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, $_GET['nombreagente'], "Movimientos del: ".$_GET['fecha_i']."  al:".$_GET['fecha_f']."\n".$_GET['nusuario']);
...
$query = $mysqli->query(" call spMuestraMovsAgente ('".$_GET["nrocuenta"]."','".$_GET["fecha_i"]."','".$_GET["fecha_f"]."') ");
$html = "";
$i = 0;
$tops = 0;
$ting = 0;
...
$html = $html   . '<tr bgcolor="#95B1CE"><td width="60">Fecha Hora</td>'
		    ...
		    . '<td width="140" align="center">Datos Adicionales</td>'
                    . '<td width="140" align="center">Datos Transferencia</td>'
                    . '<td width="180" align="center">Datos Beneficiario</td>'
                    . '<td width="30" align="center">OPs</td>'
		    . '<td width="65" align="center">Ingreso</td>'
		    . '<td width="65" align="center">Salida</td>'
		    . '<td width="60" align="center">Saldo Agente</td>'
		    . '<td width="60" align="center">Saldo Caja</td>'
                . '</tr>';
...
while ($fila = $query->fetch_array()) {
    ...
    $tops = $tops + $fila["nromovs"];
}

$html = $html . '<tfoot > <tr> <th></th> <th></th> <th></th> <th></th> <th>Totales</th>';
$html = $html .	'<th align="rigth" style="font-size:120%;">' .$tops. '</th>';
...
$html = $html .	'<th></th> <th></th> </tr> </tfoot>';
$html = $html . '</table></div>';
